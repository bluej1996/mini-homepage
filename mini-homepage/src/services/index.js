...
export default class HTTPProvider {
  ...
  post(path: string, body?: unknown, config?: AxiosRequestConfig): Promise<AxiosResponse> {
    return this.client.post(path, body, config);
  }

  postFormData(path: string, formData: FormData): Promise<AxiosResponse> {
    return this.client.postForm(path, formData);
  }

  put(path: string, body?: unknown, config?: AxiosRequestConfig): Promise<AxiosResponse> {
    return this.client.put(path, body, config);
  }

  patch(path: string, body?: unknown, config?: AxiosRequestConfig): Promise<AxiosResponse> {
